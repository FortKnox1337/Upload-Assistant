...
tracker_class_map: dict[str, type[Any]] = {
    ...
    'IHD': IHD, 'IS': IS, 'LCD': LCD, 'LDU': LDU, 'LST': LST, 'LT': LT, 'LUME': LUME, 'MNS': MNS, 'MTV': MTV, 'NBL': NBL, 'NQ': NQ, 'OE': OE, 'OTW': OTW, 'PG': PG, 'PHD': PHD, 'PT': PT, 'PTP': PTP, 'PTER': PTER, 'PTS': PTS, 'PTT': PTT,
...
api_trackers = {
    ...
    'MNS', 'NQ', 'OE', 'OTW', 'PG', 'PT', 'PTT', 'RAS', 'RF', 'R4E', 'RMC', 'SAM', 'SHRI', 'SP', 'STC', 'TIK', 'TLZ', 'TOS', 'TTR', 'ULCX', 'UTP', 'YOINK', 'YUS', 'ZNTH'
}
